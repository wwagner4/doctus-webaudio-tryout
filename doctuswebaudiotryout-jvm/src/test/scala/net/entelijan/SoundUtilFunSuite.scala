...
class SoundUtilFunSuite extends FunSuite {
  ...
  {
    val realVals = (0 to 5).toList.map { x => logarithmicDecay(1.2)(x) }
    val testVals = List(
      T1(0, 1.0), 
      T1(1, 0.83), 
      T1(2, 0.69), 
  ...
  {
    val realVals = (0 to 5).toList.map { x => logarithmicDecay(2)(x) }
    val testVals = List(
      T1(0, 1.0), 
      T1(1, 0.5), 
      T1(2, 0.25), 
  ...
  {
    val realVals = (0 to 5).toList.map { x => logarithmicDecay(4)(x) }
    val testVals = List(
      T1(0, 1.0), 
      T1(1, 0.25), 
      T1(2, 0.0625), 
